...
LOG="outputs/revision_8gpu_logs/hybrid_followup/gpu5_p08_lr5e4_nosem.log"
echo "[start] $(date '+%F %T') gpu5_p08_lr5e4_nosem" | tee -a "$LOG"
...
echo "[done] $(date '+%F %T') gpu5_p08_lr5e4_nosem" | tee -a "$LOG"

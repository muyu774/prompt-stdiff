...
LOG="outputs/revision_8gpu_logs/hybrid_mean/gpu1_p04_mean_lr5e4.log"
echo "[start] $(date '+%F %T') gpu1_p04_mean_lr5e4" | tee -a "$LOG"
...
echo "[done] $(date '+%F %T') gpu1_p04_mean_lr5e4" | tee -a "$LOG"

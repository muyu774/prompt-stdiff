...
LOG="outputs/revision_8gpu_logs/hybrid_mean/gpu4_p08_mean_lr2e4.log"
echo "[start] $(date '+%F %T') gpu4_p08_mean_lr2e4" | tee -a "$LOG"
...
echo "[done] $(date '+%F %T') gpu4_p08_mean_lr2e4" | tee -a "$LOG"
